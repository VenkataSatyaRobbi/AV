...
class SignInViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bottomLayerEmail.frame = CGRect(x: 0, y: 50, width: self.view.frame.size.width - 40 , height: 1)
        ...
        bottomLayerPassword.frame = CGRect(x: 0, y: 50, width: self.view.frame.size.width - 40 , height: 1)
