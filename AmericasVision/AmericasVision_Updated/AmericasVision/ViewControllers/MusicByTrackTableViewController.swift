//
//  MusicByTrackTableViewController.swift
//  AmericasVision
//
...
class MusicByTrackTableViewController: UITableViewController {
    ...
    func sideMenus(){
        ...
        if revealViewController() != nil {
            MusicByTrackHomeButton.target = revealViewController()
            MusicByTrackHomeButton.action = #selector(SWRevealViewController.revealToggle(_:))
